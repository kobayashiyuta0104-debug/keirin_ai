...
# ==========================================================
# 0014_collect_historical_oddspark_html.py
#
# OddsPark 対象日のHTML取得
#
# 入力:
...
print("=" * 70)
print("014 Collect Historical OddsPark HTML")
print("=" * 70)
print()
...
calendar_url = (
    ...
    f"KaisaiCalendar.do?target={START_DATE[:6]}"
)
...
for index, date in enumerate(sorted(day_map.keys()), start=1):
    ...
    with open(
        ...
        f.write(
            "<!-- GENERATED BY 014_collect_historical_oddspark_html.py -->\n"
        )
