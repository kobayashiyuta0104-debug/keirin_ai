...
# ==========================================================
# 019_collect_today_lines_html.py
#
# OddsPark 当日ライン情報HTML取得
#
# 入力:
#   OddsPark RaceList
#
...
FAILED_LOG = LOG_DIR / "today_lines_failed.txt"
...
print("=" * 70)
print("019 Collect Today OddsPark HTML")
print("=" * 70)
print()
...
for index, date in enumerate(sorted(day_map.keys()), start=1):
    ...
    outfile = SAVE_DIR / "today_lines.html"
    ...
    with open(
        ...
        f.write(
            "<!-- GENERATED BY 019_collect_today_lines_html.py -->\n"
        )
