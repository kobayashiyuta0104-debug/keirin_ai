    ...
    for idx, match in enumerate(matches):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                race_no = int(race_key.split("_")[2])

                result["race_key"] = (
                    f"{target_date}_{jo_name}_{race_no}R"
                )

                result["jo_code"] = jo_code

                result["jo_name"] = jo_name
