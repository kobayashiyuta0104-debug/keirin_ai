...
===========================================================
競輪AI Ver1.0
010_build_historical_race_features.py
...
def log(message):
    ...
    print(f"[027_build_today_race_features] {message}")
...
def build_today_race_features(race_groups):
...
def save_today_race_features(df):
...
def main():
    ...
    log("=======================================")
    log("027 Build Today Race Features")
    log("=======================================")
    ...
    # 1レース1行へ変換
    race_feature_df = build_today_race_features(
        race_groups
    )

    # CSV保存
    save_today_race_features(
        race_feature_df
    )
